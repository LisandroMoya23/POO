...
class EncadenamientoHash:
    ...
    def insertarHash(self, valor):
        ...
        self.__tabla[direccion].insertar(valor) #type: ignore

    def buscar(self,valor):
        dir = self.metodoPlegado(valor)
        resultado = self.__tabla[dir].buscar(valor)
        if resultado != -1:
            print("Se encontro: {}",resultado.getDato())
        else:
